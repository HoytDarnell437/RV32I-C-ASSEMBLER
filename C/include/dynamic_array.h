...
void array_print(array_t array, FILE *file); // Prints the contents of the array to file
...
void master_array_print(master_array_t master, FILE *file); // Prints the contents of the master array to file
