 ...
 * @param initial_capacity Initial capacity of created array in bytes.
...
*
* @param array Array tp append to.
...
*
* @param initial_capacity Initial capacity of created master array in bytes.
*
